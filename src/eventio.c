 ...
 *  @date    1991 to 2010
 *  @date    @verbatim CVS $Date: 2016/04/12 16:15:21 $ @endverbatim
...
/* The read_io_block function corresponds to IACT/ATMO package version 1.49 , PLUS 
   it includes a fix for a bug affecting very large events. Fix sent via email 
form Konrad.Bernloehr@mpi-hd.mpg.de to henrike.fleischhack@desy.de on 11th of April, 2016.*/
